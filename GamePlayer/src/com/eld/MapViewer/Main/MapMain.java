...
public class MapMain extends Application {
    ...
    public void initRootLayout() {
        try {
            ...
            loader.setLocation(MapMain.class.getResource("/com/eld/MapViewer/View/RootLayout.fxml"));
    ...
    public void showMapOverview() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MapMain.class.getResource("/com/eld/MapViewer/View/MapOverview.fxml"));
